...
(function() {
  ...
  window.graph = {
    ...
    downloadChartAsImage: function() {
      var blob, canvas, downloadLink, filename;
      canvas = document.getElementById('myChart');
      downloadLink = document.getElementById('download_link');
      filename = 'your_order.jpg';
      if (canvas.msToBlob) {
        blob = canvas.msToBlob();
        return window.navigator.msSaveBlob(blob, 'your_order.jpg');
      } else {
        downloadLink.href = canvas.toDataURL('image/jpg');
        return downloadLink.download = filename;
      }
    }
  };
